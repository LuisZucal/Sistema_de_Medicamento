...
# Configuración de la primera base de datos
    ...
    DB_SERVER = os.getenv('DB_SERVER', 'LAPTOP-IBTK3MRR\MSSQLSERVER01')  # Valor por defecto
    DB_NAME = os.getenv('DB_NAME', 'HospitalLogin')
    DB_USER = os.getenv('DB_USER', 'sa')
    DB_PASSWORD = quote_plus(os.getenv('DB_PASSWORD', 'Sa123456'))  # Escapando caracteres especiales
    ...
    DB_SERVER2 = os.getenv('DB_SERVER2', 'LAPTOP-IBTK3MRR\MSSQLSERVER01')
    DB_NAME2 = os.getenv('DB_NAME2', 'HospitalMedicamento')
    DB_USER2 = os.getenv('DB_USER2', 'sa')
    DB_PASSWORD2 = os.getenv('DB_PASSWORD2', 'Sa123456')  # No codificar aquí
